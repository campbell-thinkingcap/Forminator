...
export default {
  ...
  decorators: [
    (Story) => (
      <div style={{ background: 'var(--panel-bg)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-card)', padding: '1rem', width: '420px', height: '520px', display: 'flex', flexDirection: 'column' }}>
        <Story />
      </div>
    ),
  ],
